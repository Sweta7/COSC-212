...
<html lang="en">
    <?php
    $scriptList = array('javascript/jquery-3.3.1.min.js', 'javascript/cookies.js', 'javascript/cart_content.js',
        'javascript/validator.js', 'javascript/hide_cart.js' );
    include('header.php');
    ?>
...
<!--<nav>
	...
	<main>
         <p id="empty">
            Welcome to Classic Cinema, your cart details are :-
         </p>
           <div id="cart_details">

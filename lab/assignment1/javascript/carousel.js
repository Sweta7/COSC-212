...
var Carousel = (function(){
	...
	pub.setup = function() {
		categoryList.push(new MovieCategory("Room Type - Single", "images/room1.jpg"));
		categoryList.push(new MovieCategory("Room Type - Double", "images/room2.jpg"));
		categoryList.push(new MovieCategory("Room Type - King", "images/room3.jpg"));
		nextCategory();

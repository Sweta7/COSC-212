...
function moveBall(vx, vy) {
   ...
   // $("#ball").animate({opacity: 1 + "px", opacity: 0 + "px"}, t, "linear", function () {moveBall(vx, vy); });


    $("#ball").animate({opacity: 1, paddingLeft: tx / "px"},
...
function fadeInOut() {
    $("#ball").animate({opacity:0 },
        1000, "swing");
    $("#ball").animate({opacity:1 },
        1000, "swing", fadeInOut());

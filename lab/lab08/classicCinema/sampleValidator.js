...
var SampleValidator = (function () {
    ...
    function checkAddress(deliveryName, deliveryAddress1, deliveryCity, messages) {
        ...
        /*if (!checkLowerCase(deliveryName)){
            messages.push("You must enter a name in lowercase");
        }*/
    ...
    function checkdeliveryPostcode(deliveryPostcode, messages) {
        ...
        /*else if (!checkLength(deliveryPostcode, 4, 4)) {
    ...
    /*function display(messages) {
        ...
        element1.innerHTML = "my test";
        console.log(messages);
        if (messages !== []) {
            messages.forEach(function (list) {
                element1.innerHTML += list;
            });
        }
    }*/
    ...
    pub.setup = function () {
        ...
        document.getElementById("deliveryName").onkeypress = checkLowerCase;
